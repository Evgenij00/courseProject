...
namespace courseProject
{
    public static class SampleData
    {
        ...
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            {
                //Id = 1,
                Description = "Вас можно назвать вполне зрелым мужчиной, с устойчивыми принципами, развитой эмоционально-волевой сферой и реалистичными представлениями о себе, окружающем мире, взаимоотношениях с близкими и окружающими. В большинстве случаев, Вы настроены на конструктивное разрешение проблем с помощью анализа возможных вариантов и конкретных действий. Вы способны к целеполаганию и планированию, что стратегически обеспечивает Ваш успех в реализации идей. Можно предположить, что Вам удается выстраивать гармоничные отношения с противоположным полом и поддерживать в них гармонию.",
                Scores = 9,
                Test = test6,
            };
            ...
            {
                //Id = 3,
                Description = "Вы в начале пути к эталону мужественности, которая заключается в сильном духе, твердой воле, самостоятельности и независимости, умении сотрудничать и конструктивно разрешать конфликты, адекватно реагировать на превратности судьбы. Мы все подражаем время от времени выбранному эталону, человеку, которого считаем примером для себя. Выбирайте достойного кумира, изучайте истории героев и людей, успех которых принят в обществе и Вы избежите ошибок при формировании моделей поведения, способов решения трудных задач, выбора целей. Начало любого пути – золотое время, когда открыты все пути и можно все изменить. Успехов!",
                Scores = 3,
                Test = test6,
            };
            ...
            {
                context.Tests.AddRange(test1, test2, test3, test4, test5);
                context.SaveChanges();
            }
